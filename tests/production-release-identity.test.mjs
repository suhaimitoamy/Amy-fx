...
test('Amy FX 2.0.2 keeps the public Android identity and updater channel',()=>{
 ...
 assert.match(gradle,/com\.amyelitesuite/); assert.match(gradle,/\?: 53\)/); assert.match(gradle,/\?: "2\.0\.2"/); assert.match(gradle,/main\/update\.json/);
