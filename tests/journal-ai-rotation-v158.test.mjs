...
test('Amy FX personal source identity is Preview 2.0.0 code 940292', () => {
  ...
  assert.match(source('app/src/main/assets/app-version.js'), /name: '2\.0\.0-preview\.292', code: 940292/);
});
