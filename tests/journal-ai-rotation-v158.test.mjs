...
test('Amy FX public source identity is 2.2.1 code 57', () => {
  ...
  assert.match(gradle, /\?: 57\)/);
  assert.match(gradle, /\?: "2\.2\.1"/);
  assert.doesNotMatch(gradle, /learningpreview|Amy FX Preview|amyfxpreview|preview-update\.json/);
  assert.match(source('app/src/main/assets/app-version.js'), /name: '2\.2\.1', code: 57/);
});
