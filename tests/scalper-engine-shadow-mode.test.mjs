...
test('IFVG geometry locks next-open entry, local wick stop, 1R BE and 2R target', () => {
  const candidate = {
    model: 'IFVG_SCALPER', direction: 'BUY', status: 'WAITING_NEXT_OPEN',
    stop_reference: 100, atr_at_signal: 10, buffer_atr: 0.10, quality: {}
  };
...
test('adverse stop is checked before BE on the same candle', () => {
  const setup = {
    ...
    target_price: 117, risk: 6, max_bars: 4, bars_elapsed: 0, be_armed: false, quality: {}
  };
...
test('fourth candle exits directly without redundant BE event', () => {
  const setup = {
    ...
    last_evaluated_open_time: 1_700_001_800, quality: {}
  };
