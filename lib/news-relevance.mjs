export const NEWS_FILTER_VERSION = '2026-07-13.1';
...
export const CONFLICT_KEYWORDS = [
  ...
  'invasion', 'invasi', 'attack', 'serangan', 'strike', 'airstrike',
  'missile', 'rudal', 'drone', 'bombing', 'explosion', 'ledakan', 'troops',
  'army', 'navy', 'nuclear', 'nuklir', 'nuclear threat', 'ancaman nuklir',
  'weapon', 'weapons', 'defense', 'defence', 'hostilities', 'escalation',
  'eskalasi', 'retaliation', 'ceasefire', 'gencatan senjata', 'truce',
  'state of emergency', 'security threat', 'embargo', 'sanctions', 'sanksi',
  'tariff', 'trade war', 'border conflict', 'territorial dispute',
  'geopolitical', 'tension', 'ketegangan', 'crisis', 'krisis'
];
...
export const GEOPOLITICAL_ACTORS = [
  ...
  'palestinian', 'lebanon', 'syria', 'yemen', 'russia', 'russian',
  'ukraine', 'ukrainian', 'china', 'chinese', 'taiwan', 'north korea',
  'south china sea', 'middle east', 'nato', 'saudi arabia', 'iraq'
];
...
export const HIGH_IMPACT_KEYWORDS = [
  ...
  'rate hike', 'war', 'perang', 'invasion', 'invasi', 'attack', 'serangan',
  'strike', 'airstrike', 'missile', 'rudal', 'drone', 'bombing', 'explosion',
  'ledakan', 'nuclear', 'nuklir', 'nuclear threat', 'ancaman nuklir',
  'escalation', 'eskalasi', 'retaliation', 'ceasefire', 'gencatan senjata',
  'peace talks', 'perundingan damai', 'peace deal', 'kesepakatan damai',
  'peace agreement', 'sanctions', 'sanksi', 'embargo', 'tariff',
  'trade war', 'recession', 'resesi', 'gdp', 'government shutdown',
...
export function normalizeNewsText(value) {
  return String(value || '')
    ...
    .normalize('NFKD')
    .replace(/[\u0300-\u036f]/g, '')
    .replace(/u\s*\.\s*s\s*\.\s*a\s*\.?/g, ' usa ')
    .replace(/u\s*\.\s*s\s*\.?/g, ' us ')
