...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 35
        versionCode = (System.getenv("AMYFX_VERSION_CODE")?.toIntOrNull() ?: 940301)
        versionName = System.getenv("AMYFX_VERSION_NAME") ?: "2.0.0-preview.301"
...
dependencies {
    ...
    implementation("org.jetbrains.kotlinx-coroutines-android:1.8.1")
