(function () {
  const VERSION = window.AmyFXAppVersion || { name: '2.0.0-preview.311', code: 940311 };
  const CURRENT_VERSION_CODE = Number(VERSION.code) || 940311;
  const CURRENT_VERSION_NAME = String(VERSION.name || '2.0.0-preview.311');
