(function () {
  const VERSION = window.AmyFXAppVersion || { name: '2.0.0-preview.292', code: 940292 };
  const CURRENT_VERSION_CODE = Number(VERSION.code) || 940292;
  const CURRENT_VERSION_NAME = String(VERSION.name || '2.0.0-preview.292');
