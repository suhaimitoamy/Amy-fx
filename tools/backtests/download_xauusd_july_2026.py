...
PRICE_SIDE = "BID"
START = date(2026, 6, 1)
END_EXCLUSIVE = date(2026, 8, 2)  # June warm-up, July signals, Aug 1 lifecycle completion.
OUT_DIR = Path("backtest_output/data")
CSV_PATH = OUT_DIR / "XAUUSD_M1_DUKASCOPY_BID_2026-06-01_2026-08-01.csv"
AUDIT_PATH = OUT_DIR / "DATA_AUDIT.json"
USER_AGENT = "AmyFX-Preview-Scalper-July-2026-Backtest/1.0"
...
def download_day(day: date):
    ...
    rows = decode_day(day, payload)
    return day, url, payload, rows
...
def main() -> int:
    ...
    audit = {
        ...
        "source_rows_before_dedup": len(all_rows),
        ...
        "interpolation": False,
        "forward_fill_by_repair": False,
        "synthetic_candles_added_by_repair": False,
